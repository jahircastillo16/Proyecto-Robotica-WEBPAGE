...
if (isset($_GET['accion'])) {
    ...
    if ($resultado && mysqli_num_rows($resultado) > 0) {
        ...
        $temperaturaActual = $fila['Temperatura'];
        ...
        // Actualiza el valor de la temperatura en la tabla "Estado"
        mysqli_query($conexion, "UPDATE Estado SET Temperatura = $temperaturaNueva");
